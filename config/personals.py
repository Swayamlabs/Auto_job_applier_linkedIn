...
# Your legal name
first_name = "Sumit"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Govind"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Chitlange"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "8149284365"        # Enter your 10 digit number in quotes Eg: "9876543210"
